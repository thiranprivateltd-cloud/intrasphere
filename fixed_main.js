document.addEventListener('DOMContentLoaded', () => {
    ...
    const setupForm = (formId, url, successMsg, callback) => {
        ...
        if (form) {
            ...
            const allowedRoles = {
                'circular-form': ['CEO', 'COO', 'Project Manager & Overall Execution Lead', 'HR Admin', 'Master Administrative Access'],
                'announcement-form': ['CEO', 'COO', 'Project Manager & Overall Execution Lead', 'HR Admin', 'Master Administrative Access'],
                'task-form': ['CEO', 'COO', 'Project Manager & Overall Execution Lead', 'HR Admin', 'Master Administrative Access'],
                'meeting-form': ['CEO', 'COO', 'Project Manager & Overall Execution Lead', 'HR Admin', 'Master Administrative Access'],
                'attendance-form': ['CEO', 'COO', 'HR Admin'],
                'notice-form': ['CEO', 'COO', 'HR Admin', 'Master Administrative Access']
            };
